(function (global, factory) {
	...
	const createWorkingProgress = (current, pendingProps) => {
	...
	function ChildReconciler(shouldTrackEffects) {
	    ...
	    function reconcileChildrenArray(returnFiber, currentFirstChild, 
	    ...
	    function updateFromMap(returnFiber, existingChildren, index, 
	    // eslint-disable-next-line @typescript-eslint/no-explicit-any
	    element) {
	    ...
	    function updateFragment(returnFiber, current, 
	    // eslint-disable-next-line @typescript-eslint/no-explicit-any
	    element, key, existingChildren) {
	        let fiber;
	    ...
	    return function reconcilerChildFibers(returnFiber, currentFiber, 
	    // eslint-disable-next-line @typescript-eslint/no-explicit-any
	    newChild) {
	...
	function coomitHookEffectListUnmount(flags, lastEffect) {
	...
	function coomitHookEffectListDestroy(flags, lastEffect) {
	    commitHookEffectList(flags, lastEffect, (effect) => {
	        const destroy = effect.destroy;
	        if (typeof destroy === 'function') {
	            destroy();
	...
	function coomitHookEffectListCreate(flags, lastEffect) {
	    commitHookEffectList(flags, lastEffect, (effect) => {
	...
	function scheduledUpdateOnFiber(fiber, lane) {
	...
	function markRootUpdate(root, lane) {
